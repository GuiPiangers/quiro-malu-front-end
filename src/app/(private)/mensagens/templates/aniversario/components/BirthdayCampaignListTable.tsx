...
const BASE = '/mensagens/templates/aniversario'

type BirthdayCampaignListTableProps = {
  campaigns: BirthdayMessageResponse[]
}

export default function BirthdayCampaignListTable({
  campaigns,
}: BirthdayCampaignListTableProps) {
